        ...
        <div className={css.main}>
            <div className={css.wrapper}>
                ...
                <div className={css.button__block}>
                    <div onClick={RegisterHandler} className={css.button__block__Login}><span>Register</span></div>
                    <div onClick={LoginRegisterSwitcher} className={css.button__block__Register}>Log in?</div>
                </div>
            </div>  
        </div>
    )
